...
- 政策支持力度大""",
    ...
    {
        "name": "均线交叉策略 (Moving Average Crossover)",
        "category": "趋势跟随",
        "description": """使用两条移动平均线来判断趋势，短期均线上穿长期均线金叉买入，下穿死叉卖出。
...
- 震荡行情中会产生多次假信号""",
    ...
    },
    {
        "name": "格雷厄姆防御策略",
        "category": "价值投资",
        "description": """遵循本杰明·格雷厄姆在《聪明的投资者》中提出的防御型投资者选股标准。
...
- 适合长期价值投资""",
    ...
    },
    {
        "name": "12个月动量策略",
        "category": "趋势投资",
        "description": """基于动量效应，持有过去12个月涨幅较好的资产，汰弱留强。
...
- 每年调仓一次，操作频率低""",
    ...
    },
    {
        "name": "低波动策略",
        "category": "防御投资",
        "description": """选择并持有低波动资产，在下跌市场中表现更稳定，回撤更小。
...
- 长期来看低波动组合风险调整后收益并不低""",
    ...
    {
        "name": "海龟交易法则 (Turtle Trend Following)",
        "category": "趋势跟随",
        "description": """经典的海龟交易策略，由丹尼斯著名的海龟交易实验公开的规则。
