...
class BacktestResult(Base):
    ...
    calmar_ratio = Column(Float, nullable=True, comment="Calmar比率")
    max_drawdown = Column(Float, nullable=True, comment="最大回撤%")
    ...
    drawdown_duration = Column(Integer, nullable=True, comment="最大回撤持续天数")
    transaction_costs = Column(Float, nullable=True, comment="总交易成本%")
